...
export default class PlotsTab extends React.Component<IPlotsTabProps, {}> {
            ...
            allOptions.push({
                ...
                options: this.props.store.clinicalAttributes
                    ...
                    .map(clinicalAttribute => {
                        if (clinicalAttribute.clinicalAttributeId === "SAMPLE_COUNT") {
                            clinicalAttribute.description = "Number of Samples"
                            clinicalAttribute.displayName = "Number of Samples"
                        }
    ...
    readonly dataTypeToDataSourceOptions = remoteData<{
        ...
        invoke: () => {
            ...
            if (this.clinicalAttributeOptions.result!.length) {
                ...
                map[CLIN_ATTR_DATA_TYPE] = map[CLIN_ATTR_DATA_TYPE].map(item => {
                    if (item.value === "SAMPLE_COUNT")
                        item.label = "Number of Samples"
                    return item
                })
            }
    ...
    private getAxisMenu(
        ...
        switch (axisSelection.dataType) {
            case CLIN_ATTR_DATA_TYPE:
                dataSourceLabel = 'Pheno Attribute';
                break;
